...
//         validade: '', markup: double.parse(_markupController.text),
//         lucro: double.parse(_lucroController.text),
//         empresa: '',
//         precoConcorrencia: double.parse(_precoConcorrenciaController.text),
//       );
//
...
import '../banco de dados/database_helper.dart';
...
class _CadastroProdutoScreenState extends State<CadastroProdutoScreen> {
  ...
  Future<void> _adicionarProduto() async {
    if (_formKey.currentState!.validate()) {
      ...
      await DatabaseHelper.instance.inserirProduto(novoProduto);
      Navigator.of(context).pop();
    }
  }
            ...
            child: Column(
              ...
              children: [
                ...
                SwitchListTile(
                  title: Text('Destacar Produto'),
                  value: _destacarProduto,
                  onChanged: (value) => setState(() => _destacarProduto = value),
                ),
                SwitchListTile(
                  title: Text('Exibir no Catálogo'),
                  value: _exibirNoCatalogo,
                  onChanged: (value) => setState(() => _exibirNoCatalogo = value),
                ),
                SizedBox(height: 16),
                ElevatedButton(
                  onPressed: _adicionarProduto,
