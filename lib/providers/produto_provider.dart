...
////////////////////// abaixo está o ultimo utilizado


import 'package:flutter/material.dart';
import '../helpers/produto_db_helper.dart';
import '../models/produto.dart';
...
class ProdutoProvider with ChangeNotifier {
  ...
  final ProdutoDBHelper _dbHelper = ProdutoDBHelper();

  Future<void> carregarProdutos() async {
    _produtos = await _dbHelper.buscarTodosProdutos();
    notifyListeners();
  }
